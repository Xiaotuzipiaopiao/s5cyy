...
curl -Lo /etc/systemd/system/sing-box.service https://raw.githubusercontent.com/Xiaotuzipiaopiao/s5cyy/main/sing-box.service
...
wget https://raw.githubusercontent.com/Xiaotuzipiaopiao/s5cyy/main/config.json
